/*
    ...
    build:
        ...
        results at build/tmp/sysroots-components/zynq_generic/build-version/lib/modules/5.15.19-xilinx-v2022.1/extra/build-version.ko
    test:
        scp build/tmp/sysroots-components/zynq_generic/build-version/lib/modules/5.15.19-xilinx-v2022.1/extra/build-version.ko root@<ip>:/dev/shm
